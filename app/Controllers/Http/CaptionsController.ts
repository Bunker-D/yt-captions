 ...
 * @async
 */
async function _fetchCaptions( url: string, msResolution = true ): Promise<[string, string][]> {
	// Fetch the captions
...
/*TODO
	Keep ms level to be able to add accurate subtitle fabrication.
	Put an editable time stamp to the left of every paragraph.
